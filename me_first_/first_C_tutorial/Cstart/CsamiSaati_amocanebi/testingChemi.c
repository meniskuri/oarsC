...
int main()
{
  ...
  */
  ...
  while ((c = getchar()) != EOF)
  {
    ...
    printf("c = %c\n",c);
    printf("counter2 (sul ramdeni asoa) %d\n",counter2);
    printf("counter (sityvebshi asoebis raodenoba) %d\n",counter);
    printf("nl (sityvebis raodenoba) %d\n",nl);
...
/*
ეს კოდი შეიძლება გადავაკეთო
და მელონიც იყოს ან კერძ ი
სვანურად
ჯადო ს(ვა)ნური სიტყვები
შემიძლია ქართულ სვანური ლექსიკონით სვანური სახელები დავარქვა კვერთხებს
და ჯოხებ
და ბიტებს
...
T_თამარი    - მწვანე - ლომი
ლაი         - იისფერი - ირემი
კოროშინაძე  - იასამნისფერი - დრაკონი

ქეთო        - აქვს რუსული მანტია - უნიქორნი (მეორე ჯოხია საჭირო)
მარიკა       - წითელფერადი - მანტიკორა (მეორე ჯოხია საჭირო)
...
მარიამი - შავიოქროსფერი - ლომი ??? ვინ არის ეს მარიამი? ქარქაშაძე?
ლოსი   - ის ჯოხი არა ჭირდება ბრატ )) ბიტა
ვასო პაპა - წითელი <<<
ოთარა   - მეთვითნ მოვუფიქრო

მარიამ ჯენის - ვკითხო - და გული?  (მავიწყდება ყველაფერი იმენა რა) <<<
ლიზა ჯორჯ  - მანტიკორაო. ისე ვეფხვიო. რავი ჩამოუყალიბებელი გოგოა (მზადდება)
მარიამ პატარა - წითელი?

ყაფლანა  - შავი - მანტიკორა <<<

მარგარიტა - წითელი - დრაკონი (ეს ვინღაა?)

beren - მწვანე წითელი ყველა ფერი მკვდარი ცოცხალი ანიმაგი - დრაკონი (ჯოხის სახელია ანგლახელი)

ლუნა - ორი ჯოხი აქვს. 1 მონსტერა მეორე (ქეთის) გოგო სკარპიონის ჯოხი :)

თამრიკო - დედა, აქვს თამარ მეფის ჯოხი :))
შორენა - და, ოქროსფერი დრაკონი - ანგურიელი (ჯოხის სახელი)
*/
