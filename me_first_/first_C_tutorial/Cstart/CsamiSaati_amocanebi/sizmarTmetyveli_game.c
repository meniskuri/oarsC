...
void civa_cxela_funqcia(double sacavi_statistikis[], int mtvleli, char sacavi_civa_cxela[][MAX_LENGTH], double secret)
{
  ...
  */
  ...
  printf("(Main array) Minimum of array is : %f \n",chemMIN);
  printf("(Main array) Maximum of array is : %f \n",chemMAX);
...
/*
- ინდექსების მოძებნა
- ვაილ ლუპიდან გამოსვლა კითხვით
- რენდომ სექრეტ რიცხვის დაგენერირება როცა ეგზე ფაილს გაუშვებ???
*/
